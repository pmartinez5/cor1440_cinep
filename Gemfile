...
gem 'jn316_gen', git: "https://github.com/pasosdeJesus/jn316_gen.git", branch: :sintemas
...
gem 'sal7711_ld', git: "https://github.com/pasosdeJesus/sal7711_ld.git", branch: :sintemas
